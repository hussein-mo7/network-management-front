...
export const en: TranslationSchema = {
  ...
  auth: {
    ...
    sponsorAlt: "Jawwal Palestine",
    sponsorAria: "Sponsored by Jawwal Palestine",
  ...
  availableUsernames: {
    ...
    form: {
      ...
      importHint:
        "Upload Excel (.xlsx) for {{speed}}. Columns: Username (A), Password (B), Package (C) optional. Repeating header rows are skipped automatically. Package speed must match the selected tier. Duplicates are skipped.",
      selectFile: "Choose a file",
      importSubmit: "Import",
      importSuccess: "Imported {{count}} username(s) for {{speed}}",
      importSuccessWithSkipped:
        "Imported {{count}} username(s) for {{speed}} ({{skipped}} skipped as duplicate or header)",
      exportSuccess: "Exported available usernames for {{speed}}",
    },
  },
